...
import { Bug, CodeIcon, MessageSquare } from "lucide-react"
...
const Code = ()=>{
    ...
    return(
        <div>
           ...
           description="Generating Code from descriptive text"
           icon={CodeIcon}
                   ...
                   <div className="flex flex-col-reverse gap-y-4">
                       {messages.map((message)=>(
                        ...
                        className={cn("p-8 w-full flex item-start gap-x-8 rounded-lg", message.role==="user"?"bg-white border border-black/10": "bg-muted")}>
                            ...
                            components={{
                              pre: ({ node, ...props})=>(
                                <div className="overlow-auto w-full my-2 bg-black/10 p-2 rounded-lg">
                                  <pre {...props} />
                                </div>
                              ),
                              code: ({ node, ...props})=>(
